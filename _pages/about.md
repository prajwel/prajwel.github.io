...
I am a project scientist at the AstroSat UVIT Payload Operations Centre, Indian Institute of Astrophysics, Bangalore. 

You can find my articles on the <a href="https://scholar.google.co.in/citations?user=zSnUDggAAAAJ&hl=en">Google Scholar profile</a>.

Please check <a href="https://curvit.readthedocs.io">Curvit documentation</a> if you are interested in studying the variability of astrophysical sources using UVIT.

A Twitter thread on my most recent publication. 
...
You can reach me at my Gmail address; please add 'prajwelpj' before the Gmail domain name. 
